...
python3 marked_words.py ../generated_personas.csv --target_val asian female --target_col race gender --unmarked_val white male
"""
...
def marked_words(df, target_val, target_col, unmarked_val,verbose=False):
    ...
    for r in grams.keys():
        ...
        grams_refine[r] = temp
##
    target_words_sorted = sorted(grams_refine['target'], key=lambda x: x[1], reverse=True)
    top_20_words = target_words_sorted[:20]
